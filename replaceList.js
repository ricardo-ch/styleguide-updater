const replaceList = [
  ...
  { replace: "$superMinBlack", with: "$grey300" },
  { replace: "$minBlack", with: "$grey400" },
  { replace: "$faintBlack", with: "$grey300" },
  { replace: "$lightBlack", with: "$grey600" },
  { replace: "$darkBlack", with: "$grey900" },
  { replace: "$errorColor", with: "$statusDanger" },
